let taxiFareApiUrl = 'https://taxifare-4f3va3a5gq-ew.a.run.app/predict'; // replace with your API endpoint
...
mapboxgl.accessToken = 'pk.eyJ1Ijoic2FsYWgtYm91cmFvdWkiLCJhIjoiY2xpZWRjb2xkMGltcjNkczB0ZXIxcHFmMSJ9.niSgXGvwlAvaU3xQ4TMtVA';
  ...
  if (form) {
    form.addEventListener('submit', (e) => {
      ...
      .then(data => {
        ...
        const fareResult = document.getElementById('fare_amount');
